...
[Source: nextjs.org](https://nextjs.org/blog/next-16-3)
...
[Source: nextjs.org](https://nextjs.org/blog/next-16-3-instant-navigations)
...
The user gets an instant loading shell (reused per route, not per link), and content streams in as the server finishes. This is the SPA feel: click, see a skeleton, watch it fill.
...
[Source: nextjs.org](https://nextjs.org/docs/app/guides/instant-navigation)
...
[Source: nextjs.org](https://nextjs.org/docs/app/guides/adopting-partial-prefetching)
...
[Source: robotostudio.com](https://robotostudio.com/blog/nextjs-16-3-for-dummies)
...
[Source: nextjs.org](https://nextjs.org/docs/app/api-reference/config/next-config-js/turbopackRustReactCompiler)
...
This adds `instant = false` to every page, layout, and default export that does not already declare it. The app keeps building and serving, and you convert routes one at a time.

[Source: nextjs.org](https://nextjs.org/docs/app/guides/migrating-to-cache-components)
...
- Next.js 16.3 Announcement — [nextjs.org](https://nextjs.org/blog/next-16-3)
- Next.js 16.3: Instant Navigations — [nextjs.org](https://nextjs.org/blog/next-16-3-instant-navigations)
- Instant Navigation Guide — [nextjs.org](https://nextjs.org/docs/app/guides/instant-navigation)
- Migrating to Cache Components Guide — [nextjs.org](https://nextjs.org/docs/app/guides/migrating-to-cache-components)
- Next.js 16.3 for Dummies (Roboto Studio) — [robotostudio.com](https://robotostudio.com/blog/nextjs-16-3-for-dummies)
- Rust React Compiler Config — [nextjs.org](https://nextjs.org/docs/app/api-reference/config/next-config-js/turbopackRustReactCompiler)
- Partial Prefetching Guide — [nextjs.org](https://nextjs.org/docs/app/guides/adopting-partial-prefetching)