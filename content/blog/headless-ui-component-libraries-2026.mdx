...
tags: [Design Systems, Headless UI, Component Libraries, Radix, Base UI, shadcn/ui, React Aria, Design Engineering]
...
This is the actual 2026 story. Radix became the default primitive layer through most of the 2020s. It was created by the team behind Modulz, and when WorkOS acquired Modulz, Radix and its maintainers moved to WorkOS.[^3] In production, Radix is everywhere: the GreatFrontEnd 2026 survey notes it is battle-tested across millions of apps, and it underpins a huge share of the modern React ecosystem through both direct use and shadcn/ui.[^1]
