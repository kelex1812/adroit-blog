...
One security note from the month: the July security release patched 4 HIGH and 5 MEDIUM vulnerabilities in 16.2.11 (Active LTS) and 15.5.21 (Maintenance LTS) — upgrade if you haven't [^2].
