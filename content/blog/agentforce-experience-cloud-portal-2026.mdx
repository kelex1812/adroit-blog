...
tags: [Salesforce, Agentforce, "Experience Cloud", "AI Agents", "Data Cloud"]
...
That cuts two ways on a customer portal. If your agent runs as a service user with broad read access to Opportunity or Case, every visitor who chats with it inherits that ceiling, whether logged in or an anonymous guest.[^7] Give the portal agent a dedicated user with a permission set scoped to exactly the objects and fields the portal needs, and make that scope part of the design review, not an afterthought.
