...
authorInitials: "AC"
readTime: 9
tags: [Salesforce, MCP, Agentforce, "Data 360", "AI Agents"]
...
1. **Enable a server.** Setup, then API Catalog, then MCP Servers. Enable a standard server or create a custom one. Custom servers are available in Developer, Enterprise, Performance, and Unlimited editions [^2].
