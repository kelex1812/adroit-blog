...
export const NEBULAE = [
  { id: "hf2-neb-a", cx: 250, cy: 300, rx: 420, ry: 330, rot: -18, color: "#3560b8", alpha: 0.62, drift: 74 },
  { id: "hf2-neb-b", cx: 760, cy: 420, rx: 380, ry: 300, rot: 24, color: "#6640a8", alpha: 0.55, drift: 91 },
  { id: "hf2-neb-c", cx: 520, cy: 760, rx: 460, ry: 280, rot: -8, color: "#1f7a90", alpha: 0.45, drift: 108 },
  { id: "hf2-neb-d", cx: 830, cy: 830, rx: 310, ry: 260, rot: 40, color: "#94476e", alpha: 0.4, drift: 83 },
  { id: "hf2-neb-e", cx: 140, cy: 720, rx: 330, ry: 270, rot: 12, color: "#35509c", alpha: 0.45, drift: 97 },
] as const;
