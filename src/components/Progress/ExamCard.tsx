    ...
    <section aria-label="Cert prep exam card" className="max-w-[760px] mx-auto px-6 pb-14">
      ...
      >
        <div className="flex items-start justify-between gap-4 mb-2.5">
          <div>
            <div className="font-mono text-[10.5px] font-bold text-navy uppercase tracking-[0.09em] mb-1">
              Cert Prep Exam
            </div>
            <h3 className="text-[1.15rem] font-extrabold text-navy tracking-[-0.02em]">
              Certification Prep Exam
            </h3>
          </div>
          <span
            className={`font-mono text-[10.5px] font-bold px-3 py-1 rounded-full ${
              unlocked ? "bg-emerald/10 text-emerald-800" : "bg-gray-100 text-gray-500"
            }`}
          >
        ...
        <div className="flex items-center gap-2 font-mono text-[11px] font-bold text-gray-500 border-t border-gray-100 pt-3">
          {unlocked ? (
            <>
              ...
              <span className="text-emerald-800">Unlocked — all {totalChecks} checks passed</span>
            </>
          ) : (
            <>
              ...
              <span>
                Locked — checks passed <b className="text-navy">{passedCount}/{totalChecks}</b> · 80% required
              </span>
            </>
          )}
        </div>
        ...
        {!unlocked && (
          <div className="h-[5px] rounded-full bg-gray-200 overflow-hidden mt-2.5 mb-3.5">
            <div
        ...
        {unlocked ? (
          ...
          <button
            disabled
            className="w-full h-11 rounded-xl bg-gray-100 text-gray-400 text-[13.5px] font-bold cursor-not-allowed"
          >
